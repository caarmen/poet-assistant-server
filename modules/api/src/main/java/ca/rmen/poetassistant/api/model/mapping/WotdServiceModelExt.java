...
public class WotdServiceModelExt {
    public static WotdApiModel toApi(WotdServiceModel serviceModel) {
        return new WotdApiModel(serviceModel.date(), serviceModel.word());
    }
}
